...
>
> To people who ask, why the hash should be encoded with base64, is simple, it ensures the result doesn't contain any special character, meaning it's safe to use in another functions.
